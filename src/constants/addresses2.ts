...
const BUTTER_ROUTER_ADDRESSES:any={
  ...
  [CHAIN_ID.ETH_PRIV]: '',
  [CHAIN_ID.ETH_GOERLI]: '0x8A75D36796f823d21284C79A5Ab80ACaA90BB77a',
  [CHAIN_ID.BNB_TEST]: '0x9920f3d762C13b1AbbC8c3D8425C61B0EAe9213b',
  [CHAIN_ID.MAP_TEST]: '',
  [CHAIN_ID.POLYGON_TEST]: '0x409425E311eda1DbfBe6480dC230C40bf1eA276D',
  [CHAIN_ID.NEAR_TEST]: '',
}
